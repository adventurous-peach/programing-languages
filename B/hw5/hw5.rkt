...
(define (racketlist->mupllist lst)
  (if (empty? lst) (aunit) (apair (car lst) (racketlist->mupllist (cdr lst)))))

(define (mupllist->racketlist lst)
  (if (aunit? lst) '() (cons (apair-e1 lst) (mupllist->racketlist (apair-e2 lst)))))
...
(define (eval-under-env e env)
  (cond [(var? e) 
        ...
        [(apair? e) (let ([e1 (eval-under-env (apair-e1 e) env)]
                      ...
                      (apair e1 e2))]
        [(fst? e) (let ([mupl-exp (eval-under-env (fst-e e) env)])
                    (if (apair? mupl-exp) (apair-e1 mupl-exp)
